...
const CustomsPage = () => {
  ...
  return (
    <div className="container mx-auto p-4 md:p-8 space-y-8">
      <header>
        <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Carina</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-1">Pregled fiksnih tankova i historijata ulaza goriva za carinske potrebe.</p>
      </header>
          ...
          <CardContent>
            <div className="mb-4 p-4 border dark:border-gray-700 rounded-md bg-gray-50 dark:bg-gray-800/50">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-end">
                ...
                {/* Optional: Add a button to explicitly trigger refresh if needed, though useEffect in AllIntakesList handles it */}
              </div>
            </div>
            <AllIntakesList 
